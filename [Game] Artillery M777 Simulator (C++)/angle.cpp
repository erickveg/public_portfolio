...
{
   angleRadians = rhs.getRadians();
}

/******************************************************
 * ANGLE :: NEGATIVE OPERATOR
 ******************************************************/
Angle Angle::operator-()
{
   return Angle(this->getRadians() + M_PI);
}

/******************************************************
 * ANGLE :: INCREMENT PREFIX
 ******************************************************/
Angle& Angle::operator++()
{
   this->setDegrees(this->getDegrees() + 1);
   return *this;
}

/******************************************************
 * ANGLE :: INCREMENT POSTFIX
 ******************************************************/
Angle Angle::operator++(int postfix)
{
   Angle original = *this;
   this->setDegrees(this->getDegrees() + 1);
   return original;
